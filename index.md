...
patchclampplotteR provides a set of user-friendly tools for
electrophysiologists who want to plot and analyze data from whole-cell
patch clamp electrophysiology recordings. Here’s some of the functions
that this package can do (see below for examples!):

![A banner with pictures of some of the plots that can be created with
the patchclampplotteR
package.](reference/figures/README-plot-sampler.png)
...
insulin.](reference/figures/README-example-raw-eEPSC-plot-1.png)
...
males and
females.](reference/figures/README-example-summary-eEPSC-plot-1.png)
...
![A representative trace from a raw abf recording, showing a series of
noisy, negative-going peaks. Each peak represents a spontaneous
current](reference/figures/README-example-spontaneous-current-trace-plot-1.png)
...
colour](reference/figures/README-ap-trace-viridis-1.png)
...
lower after adding
insulin.](reference/figures/README-ap-frequencies-one-treatment-1.png)
