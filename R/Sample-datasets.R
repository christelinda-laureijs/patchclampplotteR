...
#' sample_raw_eEPSC_df
#'
#' This is an example of the raw eEPSC data produced using [make_normalized_EPSC_data()]. It is useful for demonstrating functions that build off of this dataset, such as [make_pruned_EPSC_data()] and plotting functions.
#'
