...
where `current_type == "sEPSC"`. The dataframe can be used for further
statistical analyses, and it also has specialized columns to add
significance stars to the plot produced with
...
- `.y.`:
  ...
  In this case, this uses the mean normalized amplitude of spontaneous
  current ("mean_transformed amplitude") which has been generated using
