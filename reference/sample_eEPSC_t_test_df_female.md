...
NOTE: This data is actually THE SAME DATA as
...
and it is for demonstration purposes only. It helps to illustrate an
example of plotting both sexes with separate significance stars for each
sex in
