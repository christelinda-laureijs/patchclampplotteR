...
12. Click OK and view the `Results` sheet (`Window` -> `Results1` or `Alt+w+2`). Copy the R1S1 and R2S1 columns, which correspond to the first and second evoked currents, respectively.
