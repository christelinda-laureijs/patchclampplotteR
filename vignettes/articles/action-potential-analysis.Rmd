...
18. You are now ready to import your data into R! Use the `add_new_cells()` function with `data_type = "AP"`. You may find it helpful to read the [Get Started](https://christelinda-laureijs.github.io/patchclampplotteR/articles/patchclampplotteR.html) guide if you are setting up your data for the first time.
