...
my_new_theme <- patchclampplotteR_theme() %+replace%
  theme(text = element_text(size = 25, color = "#333333"),
...
Now, insert this theme into the `ggplot_theme` argument. Here's an example of the new theme applied to one of the action potential plots:
