...
```{r millie-picture, echo=F, fig.align='center', fig.alt = "So much data!", fig.cap = "So much data! Millie the Mouse is exploring plots made with patchclampplotteR."}
knitr::include_graphics("Millie-desk-2.jpg")
```
