...
You can comment out this code for now, as you don't need to repeatedly run it each time you run your RMardown file. Just un-comment it and run it whenever you have new data.
