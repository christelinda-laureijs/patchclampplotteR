...
```{r ruby-picture, fig.alt = "A picture of a knitted white rat sitting on a keyboard and working at a computer.", fig.cap = "Ruby says 'Have fun with data analysis!'"}
knitr::include_graphics("articles/figures/Ruby-desk.jpg")
```
